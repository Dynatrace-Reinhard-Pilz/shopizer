...
public class TaxServiceImpl 
	...
	public List<TaxItem> calculateTax(OrderSummary orderSummary, Customer customer, MerchantStore store, Language language) throws ServiceException {
		...
		if(taxBasisCalculation.name().equals(TaxBasisCalculation.SHIPPINGADDRESS.toString())){
		...
		} else if(taxBasisCalculation.name().equals(TaxBasisCalculation.BILLINGADDRESS.toString())){
		...
		} else if(taxBasisCalculation.name().equals(TaxBasisCalculation.STOREADDRESS.toString())){
