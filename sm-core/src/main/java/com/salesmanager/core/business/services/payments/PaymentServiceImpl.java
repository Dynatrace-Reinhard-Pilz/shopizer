...
public class PaymentServiceImpl implements PaymentService {
	...
	throws ServiceException {
		...
		if(CreditCardType.MASTERCARD.equals(creditCard)) {
			if (number.length() != 16
		...
		if(CreditCardType.VISA.equals(creditCard)) {
		...
		if(CreditCardType.AMEX.equals(creditCard)) {
			if (number.length() != 15
		...
		if(CreditCardType.DINERS.equals(creditCard)) {
			if (number.length() != 14
		...
		if(CreditCardType.DISCOVERY.equals(creditCard)) {
			if (number.length() != 16
